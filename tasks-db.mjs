...
const VALID_STATUSES = new Set(['proposed', 'backlog', 'in_progress', 'review', 'done', 'archive']);
...
export function getDb() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS tasks (
      ...
      status TEXT NOT NULL DEFAULT 'backlog' CHECK(status IN ('proposed','backlog','in_progress','review','done','archive')),
